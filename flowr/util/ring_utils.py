...
def substructure(mol_lib):
    ...
    ring_size_statis["tri_ring"]["rate"] = (
        ring_size_statis["tri_ring"]["num"] / total_num
    )
    ring_size_statis["qua_ring"]["rate"] = (
        ring_size_statis["qua_ring"]["num"] / total_num
    )
    ring_size_statis["fif_ring"]["rate"] = (
        ring_size_statis["fif_ring"]["num"] / total_num
    )
    ring_size_statis["hex_ring"]["rate"] = (
        ring_size_statis["hex_ring"]["num"] / total_num
    )
    ring_size_statis["hep_ring"]["rate"] = (
        ring_size_statis["hep_ring"]["num"] / total_num
    )
    ring_size_statis["oct_ring"]["rate"] = (
        ring_size_statis["oct_ring"]["num"] / total_num
    )
    ring_size_statis["big_ring"]["rate"] = (
        ring_size_statis["big_ring"]["num"] / total_num
    )
    ring_size_statis["fused_ring"]["rate"] = (
        ring_size_statis["fused_ring"]["num"] / total_num
    )
    ring_size_statis["unexpected_ring"]["rate"] = (
        ring_size_statis["unexpected_ring"]["num"] / total_num
    )
    for k in ring_size_statis["sssr"]:
        ring_size_statis["sssr"][k]["rate"] = (
            ring_size_statis["sssr"][k]["num"] / total_num
        )
    return ring_size_statis


def substructure_mol(mol):
    ring_size_statis = {
        "tri_ring": {"num": 0},
        "qua_ring": {"num": 0},
        "fif_ring": {"num": 0},
